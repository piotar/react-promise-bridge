        ...
        <Fragment>
            <article style={style}>
                ...
                <nav>
                    <Button
                        type="button"
                        onClick={() => alert("This is a success alert", "Success").then(console.log)}
                    >
                        Open success alert
                    </Button>
                    <Button
                ...
                <nav>
                    ...
                    <Button
                        type="button"
                        onClick={() => confirm("Lorem ipsum dolor sit...", "Some example header").then(console.log).catch(console.warn)}
                    >
                        Open confirm
                    </Button>
                </nav>
